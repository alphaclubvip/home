...
<template>
  <div>
    <div class="bg-gray-800">
      <div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8 lg:pt-20">
        ...
        <div v-if="!account" class="text-center">
          <ConnectWallet class="mt-8 jt-btn-md white focus:ring-offset-gray-800">
        ...
        <div v-else>
          <dl class="
            ...
            <div class="flex flex-col">
              ...
              <dd class="order-1 text-5xl font-extrabold text-white">
                <FormattedBN :bn-value="maxPriorityFeePerGas" :decimals="9" :padding="2" />
              </dd>
            </div>
            <div class="flex flex-col mt-10 sm:mt-0">
              ...
              <dd class="order-1 text-5xl font-extrabold text-white">
                <FormattedBN :bn-value="maxFeePerGas" :decimals="9" :padding="2" />
              </dd>
            </div>
            <div class="flex flex-col mt-10 sm:mt-0">
          ...
          <GasPosition @percent-updated="updatePencent" :length="length" :front-index="frontIndex" class="pt-20" />
        </div>
      </div>
    </div>

    <LAutoWidth v-if="nextBlock" class="py-16 px-4 sm:px-6 lg:py-20 lg:px-8">
      <GasCalculator :max-priority-fee-per-gas="maxPriorityFeePerGas" :max-fee-per-gas="maxFeePerGas"
    ...
    <GasTxsTable v-if="nextBlock" :next-block="nextBlock" :pending-transactions="pendingTransactions"
